...
faces=cv2.CascadeClassifier('E:/22_Insource_Tech/CSE/22CI1514 - Mouse and Keyword/code/gesture-updated code/haarcascade_frontalface_default.xml')

# to detect the eyes
eyes=cv2.CascadeClassifier('E:/22_Insource_Tech/CSE/22CI1514 - Mouse and Keyword/code/gesture-updated code/haarcascade_eye.xml')
